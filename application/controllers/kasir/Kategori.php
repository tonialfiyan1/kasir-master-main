...
class Kategori extends CI_Controller {
	...
	{		
        ...
        foreach ($list as $getData) {
            ...
            $row[] = '<a href="'.base_url('kasir/kategori/edit/'.$getData->id).'" class="btn btn-info">Edit</a>
            		<a class="btn btn-danger deleteData" href="'.base_url('kasir/kategori/hapus/'.$getData->id).'">Hapus</a>';
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('kasir/kategori/tambah', $data);
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('kasir/kategori/edit', $data);
