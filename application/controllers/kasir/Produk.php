...
class Produk extends CI_Controller {
	...
	{		
        ...
        foreach ($list as $getData) {
            ...
            $row[] = $getData->stok;
            $row[] = $getData->satuan;
            $row[] = '<a href="'.base_url('kasir/produk/edit/'.$getData->id).'" class="btn btn-info">Edit</a>
            		<a class="btn btn-danger deleteData" href="'.base_url('kasir/produk/hapus/'.$getData->id).'">Hapus</a>';
	...
	public function tambah()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('kasir/produk/tambah', $data);
	...
	public function edit($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('kasir/produk/edit', $data);
