...
class KwitansiModel extends CI_Model 
{
	var $table = 'kwitansi';
	var $active = NULL;
	var $column_order = array(null, 'kwitansi.kode_pesanan','produk','jumlah');
    var $column_search = array('kwitansi.kode_pesanan','produk','jumlah'); 
    var $order = array('kwitansi.kode_pesanan' => 'asc'); // default order 
    ...
    {
        $this->db->select('*, sum(pesanan.jumlah) as jumlah, kwitansi.id as id');
        $this->db->join('pesanan', 'pesanan.kode_pesanan = '.$this->table.'.kode_pesanan');
	...
	{
        $this->db->select('*, kwitansi.id as id');
        $this->db->join('pesanan', 'pesanan.kode_pesanan = '.$this->table.'.kode_pesanan');
        $this->db->join('produk', 'produk.id = pesanan.id_produk');
		if ($this->active) {
