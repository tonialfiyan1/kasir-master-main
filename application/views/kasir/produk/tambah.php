                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">                                           
                                        <div class="col-12">
                                            <?= form_open('kasir/produk/tambah', array('enctype' => 'multipart/form-data')) ?>

                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Kode Produk</label>
                                                        <input type="text" class="form-control" value="<?= set_value('kode'); ?>" name="kode" placeholder="Masukan kode barcode disini">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control rounded" name="id_kategori">
                                                            ...
                                                            <?php foreach ($kategori as $value): ?>
                                                                <option <?= set_value('id_kategori') == $value->id ? 'selected' : ''; ?> value="<?= $value->id ?>"><?= $value->kategori ?></option>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="<?= set_value('produk'); ?>" class="form-control" name="produk" placeholder="Nama Produk">
                                                        <?= form_error('produk', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress2">Merek Produk</label>
                                                        <input type="text" value="<?= set_value('merek'); ?>" class="form-control" name="merek" placeholder="Nama merek produk">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="<?= set_value('harga'); ?>" name="harga" id="rupiah" class="form-control" name="text" placeholder="Masukan harga">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="<?= set_value('stok'); ?>" onkeypress="return hanyaAngka(event)" class="form-control rounded" name="stok" placeholder="Masukan stok">
                                                        <?= form_error('stok', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4">Satuan</label>
                                                        <input type="satuan" class="form-control" value="<?= set_value('satuan'); ?>"  name="satuan" placeholder="Masukan Satuan">
